...
export function Toasts() {
  ...
  return (
    <div style={{ position: 'fixed', bottom: mobile ? 'calc(72px + env(safe-area-inset-bottom))' : 20, left: '50%', transform: 'translateX(-50%)', display: 'flex', flexDirection: 'column', gap: 8, zIndex: 200, alignItems: 'center', pointerEvents: 'none' }}>
      {toasts.map((t) => (
